...
public class C {
	...
	public static String solution(int C, int R, int M) {
...
//		Scanner reader = new Scanner(new FileReader(dir+"D-small-practice.in"));
//		PrintWriter writer = new PrintWriter(new FileWriter(dir+"D-small-practice.out"));
//		Scanner reader = new Scanner(new FileReader(dir+"D-large-practice.in"));
//		PrintWriter writer = new PrintWriter(new FileWriter(dir+"D-large-practice.out"));
